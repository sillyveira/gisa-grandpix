...
function RedBull() {
  ...
  useEffect(() => {
    const fetchParticipantes = async () => {
      try {
        const membros = await getParticipantes('RedBull');
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <header className="bg-white shadow-md p-4 flex justify-between items-center">
        ...
        <h2 className="text-lg font-semibold text-gray-800">
          Participantes da equipe: <span className="text-blue-800">RedBull</span>
        </h2>
      </header>
      ...
      <main className="p-6 text-center">
        ...
        <div className="mb-6">
          <img
            src="https://cdn-9.motorsport.com/images/mgl/Y99JQRbY/s8/red-bull-racing-logo-1.jpg"
            alt="RedBull"
            className="mx-auto h-40 object-contain"
          />
        </div>

        <h1 className="text-4xl font-bold mb-6 text-gray-800">Participantes da equipe RedBull</h1>
