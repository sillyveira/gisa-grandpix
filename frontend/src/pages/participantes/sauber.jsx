...
function Sauber() {
  ...
  useEffect(() => {
    const fetchParticipantes = async () => {
      try {
        const membros = await getParticipantes('Sauber');
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <header className="bg-white shadow-md p-4 flex justify-between items-center">
        ...
        <h2 className="text-lg font-semibold text-gray-800">
          Participantes da equipe: <span className="text-green-800">Sauber</span>
        </h2>
      </header>
      ...
      <main className="p-6 text-center">
        ...
        <div className="mb-6">
          <img
            src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/94/Sauber_F1_Team_logo.svg/1280px-Sauber_F1_Team_logo.svg.png"
            alt="Sauber"
            className="mx-auto h-40 object-contain"
          />
        </div>

        <h1 className="text-4xl font-bold mb-6 text-gray-800">Participantes da equipe Sauber</h1>
